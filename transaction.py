...
from data_structures import TableMetadata, Snapshot, DataFile, ManifestFile, ManifestContent, FileFormat
from metadata_manager import MetadataManager, ConcurrentModificationException
...
class Table:
    ...
    def _initialize_table(self):
        ...
        from .data_structures import TableMetadata, Schema, PartitionSpec, SortOrder
