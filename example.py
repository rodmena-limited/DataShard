...
def main():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print(f"  - Table creation and metadata management")
        print(f"  - ACID transactions with commit/rollback")
        print(f"  - Multiple snapshots creation")
        print(f"  - Time travel functionality")
        print(f"  - Snapshot history tracking")
