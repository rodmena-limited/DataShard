...
def create_table(table_path: str, schema: Schema = None, partition_spec: PartitionSpec = None) -> Table:
    """
...
__all__ = [
    ...
    'Schema', 'PartitionSpec', 'SortOrder', 'DataFile', 
    'DeleteFile', 'ManifestFile', 'Snapshot'
]